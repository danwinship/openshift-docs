...
+
If your cluster requires different MTU values for different nodes, then you must set this value to `50` less than the lowest MTU value in your cluster. For example, if the smallest MTU in your cluster is `900`, then you must set this value to `850`.
